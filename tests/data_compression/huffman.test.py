from thealgorithm.data_compression.huffman import *
import unittest
...
class TestHuffmanCoding(unittest.TestCase):
    ...
    def test_huffman_encoding(self):
        encoded_data, codes = huffman_encoding(self.sample_text)
    ...
    def test_empty_text(self):
        encoded_data, codes = huffman_encoding(self.empty_text)
    ...
    def test_double_char_text(self):
        encoded_data, codes = huffman_encoding(self.double_char_text)
        decoded_data = huffman_decoding(encoded_data, codes)
        self.assertEqual(decoded_data, self.double_char_text)

    def test_general_case(self):
        encoded_data, codes = huffman_encoding(self.test_text)
        decoded_data = huffman_decoding(encoded_data, codes)
